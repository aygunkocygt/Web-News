  ...
  <div class="container-fluid">
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
      ...
      <ul class="mn-primarymenu nav navbar-nav navbar-right">
         ...
         <li <?php echo $SayfaNe == "anasayfa" ? ' class="active"': null; ?> ><a href="<?php echo $SiteUrl; ?>?aygunkocygt.com" title="">Anasayfa</a></li>

        <li <?php echo $SayfaNe == "makaleler" ? ' class="active"': null; ?> ><a href="<?php echo $SiteUrl; ?>?Gelen=makaleler" title="">Haberler</a></li>   


         <li <?php echo $SayfaNe == "videolar" ? ' class="active"': null; ?> ><a href="<?php echo $SiteUrl; ?>?Gelen=videolar" title="">Videolar</a></li>   

        
         <li <?php echo $SayfaNe == "hakkimizda" ? ' class="active"': null; ?> ><a href="<?php echo $SiteUrl; ?>?Gelen=hakkimizda" title="">Hakkımızda</a></li>  
          <li <?php echo $SayfaNe == "iletisim" ? ' class="active"': null; ?> ><a href="<?php echo $SiteUrl; ?>?Gelen=iletisim" title="">İletişim</a></li>
           ...
           <li class="dropdown">
                        ...
                        <ul class="dropdown-menu navbar-inverse acilirMenu">
                            <li>
                                <form role="search" action="<?php echo $SiteUrl; ?>?Gelen=arama" class="navbar-form">
