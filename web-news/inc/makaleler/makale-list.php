...
<?php
    $MakaleList = Sor("SELECT KatID, AltKatID, Title, Url, Description, Img, Tarih FROM makaleler_tr ORDER BY ID  DESC ");
    if(Say($MakaleList)>0){
                ...
                <div class="panel-heading MakaleListTitle">
                    <h3 class="panel-title">
                        ...
                        <span class="hidden-xs pull-right MakaleEkleyenBilgi">
                            <a href="" title="">'.$MakaleListYaz["Tarih"].'</a> tarihinde eklendi.
